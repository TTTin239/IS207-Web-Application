                    ...
                    <tr>
                        ...
                        <td>
                            <form action="" method="post">
                                ...
                                <input type="number" name="quantily" min="0"
                                    value="<?php echo $result['cart_Quantily'] ?>" />
            ...
            <div style="height: 200px; margin-top: 30px">
                ...
                <div style="float: left;width: 33%;text-align: center">
                    <form action="momo.php" method="POST">
                        <input type="hidden" name="total" value="<?php echo $sum ?>">
                        <button style="background: red" class="btn btn-success" name="captureWallet">Thanh toán QR
                            MOMO</button>
                    </form>
                </div>
                <div style="float: right;width: 34% ;text-align: left">
                    <form action="momo.php" method="POST">
                        <input type="hidden" name="total" value="<?php echo $sum ?>">
                        <button style="background: red" class="btn btn-success" name="payWithATM">Thanh toán ATM
                            MOMO</button>
                    </form>
                </div>
            </div>
