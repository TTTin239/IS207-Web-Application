    ...
    <div class="content">
        ...
        <div class="section group">
            ...
            <div class="grid_1_of_4 images_1_of_4">
                <a href="details.php?prdid=<?php echo $result['prd_Id'] ?>"><img
                        src="admin/uploads/<?php echo $result['prd_Image'] ?>" alt="" /></a>
                ...
                <div class="button"><span><a href="details.php?prdid=<?php echo $result['prd_Id'] ?>"
